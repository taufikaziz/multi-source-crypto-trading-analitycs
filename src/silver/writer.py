...
class SilverWriter:
    def __init__(self, base_path: str = "data/silver") -> None:
    ...
    async def write_market_snapshot(
        ...
        """
        Write a Silver Parquet file atomically.
        ...
        output_file = output_dir / f"market_snapshot_{run_id}.parquet"
        ...
        logger.info("Silver data written successfully: %s", output_file)
